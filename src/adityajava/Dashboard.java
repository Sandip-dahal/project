...
eventoption2.setIcon(scaledicon); // transform it back
    ...
    private void initComponents() {
        ...
        Eventlbl1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Eventlbl1MouseClicked(evt);
            }
        });
        ...
        jLabel6.setText("fuck");
        jPanel16.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 100, 100, 40));
    ...
    private void usericonMouseClicked(java.awt.event.MouseEvent evt) {                                      
        // TODO add your handling code here:
    ...
    private void message_iconMouseClicked(java.awt.event.MouseEvent evt) {                                          
        // TODO add your handling code here:
              int count=evt.getClickCount();
        if(count==1){
            userpanel.setVisible(false);
    ...
    private void usericonMouseMoved(java.awt.event.MouseEvent evt) {                                    
        // TODO add your handling code here:
               userpanel.setVisible(true);
        notification_panel.setVisible(false);
        message_panel.setVisible(false); 
    ...
    private void userpanelMouseMoved(java.awt.event.MouseEvent evt) {                                     
        // TODO add your handling code here:
            userpanel.setVisible(true);
        notification_panel.setVisible(false);
        message_panel.setVisible(false); 
    ...
    private void notificationMouseMoved(java.awt.event.MouseEvent evt) {                                        
        // TODO add your handling code here:
         userpanel.setVisible(false);
        notification_panel.setVisible(true);
        message_panel.setVisible(false); 
    ...
    private void message_iconMouseMoved(java.awt.event.MouseEvent evt) {                                        
        // TODO add your handling code here:
         userpanel.setVisible(false);
        notification_panel.setVisible(false);
        message_panel.setVisible(true); 
    ...
    private void jPanel16MouseMoved(java.awt.event.MouseEvent evt) {                                    
        // TODO add your handling code here:
    ...
    private void Eventlbl1MouseClicked(java.awt.event.MouseEvent evt) {                                       
        // TODO add your handling code here:
